...
- **JSON Validation** - Real-time JSON syntax checking with formatting support
- **Timestamp Validation** - Warns when timestamps are outside Datadog's acceptable range (Metrics: ±1h, Logs: -18h/+2h)
